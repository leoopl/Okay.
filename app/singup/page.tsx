...
export default function Longin() {
    return (
      <>
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 bg-[rgb(182,207,184)] lg:px-8 bg">
          ...
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <p className="mt-2 text-center text-sm text-gray-900 small-caps">
              Já tem conta?{' '}
              <Link href="/singin" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
                Entrar
              </Link>
            </p>
          </div>
